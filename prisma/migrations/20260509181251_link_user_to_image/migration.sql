...
INSERT INTO "new_User" ("created_at", "deleted_at", "email", "first_name", "last_name", "password", "role_id", "updated_at", "user_id") SELECT "created_at", "deleted_at", "email", "first_name", "last_name", "password", "role_id", "updated_at", "user_id" FROM "User";
DROP TABLE "User";
