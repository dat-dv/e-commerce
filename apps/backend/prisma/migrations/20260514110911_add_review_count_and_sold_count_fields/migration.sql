...
INSERT INTO "new_products" ("base_price", "brand_id", "created_at", "deleted_at", "id", "rating", "seller_id", "slug", "sold_count", "status", "thumbnail_id", "updated_at") SELECT "base_price", "brand_id", "created_at", "deleted_at", "id", "rating", "seller_id", "slug", "sold_count", "status", "thumbnail_id", "updated_at" FROM "products";
DROP TABLE "products";
