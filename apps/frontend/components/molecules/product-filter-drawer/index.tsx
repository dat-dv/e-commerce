          ...
          >
            <div className="flex h-16 shrink-0 items-center justify-between border-b border-content/10 px-4">
              <div className="min-w-0">
                <h2 className="truncate text-sm font-black uppercase tracking-[0.18em] text-content">
                  {t("filters")}
                </h2>
                <p className="mt-0.5 line-clamp-1 text-xs font-medium text-content/45">
              ...
              <Button
                variant="ghost"
                onClick={onClose}
                className="size-10 shrink-0 rounded-full p-0 text-content/60 hover:bg-content/5 hover:text-content"
