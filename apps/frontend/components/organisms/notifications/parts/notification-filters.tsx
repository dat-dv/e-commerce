  ...
  return (
    <div className="flex items-center p-1 rounded-2xl bg-surface border border-content/[0.08] hover:border-content/[0.15] transition-all duration-300 shadow-sm shadow-content/[0.02]">
      <div className="relative flex-1 group">
        ...
        />
        <button className="absolute right-1.5 top-1/2 -translate-y-1/2 px-6 py-2 bg-content/[0.06] hover:bg-content/[0.12] text-content rounded-full text-xs font-bold transition-all active:scale-95">
          Search
        </button>
      </div>
    </div>
