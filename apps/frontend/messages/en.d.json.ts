...
declare const messages: {
  ...
  "CategoriesPage": {
    ...
    "content": {
      ...
      "viewMore": "{count, plural, one {# more} other {# more}}",
      "noChildren": "Browse products in this category.",
    ...
    "sidebar": {
      ...
      "filterButton": "Filter",
      "closeDrawer": "Close categories filter",
  ...
  "Common": {
    ...
    "rootMetadata": {
      "title": {
        "default": "Chotdon - E-commerce Platform",
        "template": "%s | Chotdon"
      },
      "siteName": "Chotdon",
      "description": "Smart shopping, fast ordering with Chotdon.",
  ...
  "AdminFlashSalesPage": {
    ...
    "attachProductsForm": {
      "title": "Attach Product to Flash Sale",
      "description": "Add a specific product SKU with promotional price and stock restrictions.",
      "flashSale": "Select Flash Sale Campaign",
      ...
      "cancel": "Cancel",
      "submit": "Attach Product",
      "loadingProducts": "Loading products..."
    },
    "detail": {
      "backToList": "Back to Campaigns",
      "campaignInfo": "Campaign Information",
      "attachedProducts": "Attached Products ({count})",
      "timeSlot": "Daily Time Slot",
      "timeSlotNone": "None (Full Day)",
      "timeSlotRange": "{start} - {end}",
      "duration": "Duration",
      "status": "Status",
      "attachProductBtn": "Attach Product",
      "refreshBtn": "Refresh Details",
      "retryBtn": "Retry",
      "loadErrorTitle": "Unable to load campaign",
      "loadErrorDescription": "Campaign information could not be loaded. Please try again.",
      "emptyAttachedProducts": "No products have been attached to this campaign yet.",
      "emptyAttachedProductsDescription": "Attach a product SKU to start configuring promotional price, stock, and order limits.",
      "table": {
        "product": "Product",
        "sku": "SKU Attributes",
  ...
  "HelpCenter": {
    ...
    "headers": {
      ...
      "faq": {
        ...
        "description": "Find answers to common questions about using Chot.Don, account safety, and payment processing."
      }
    },
    "contact": {
    ...
    "help": {
      "title": "Help Center",
      "desc": "Practical help for shopping on Chot.Don: account setup, cart, checkout, orders, delivery, returns, and support.",
      "search": "Search account, cart, checkout, orders, shipping...",
      "quick": "What do you need help with?",
      "popular": "Popular Answers",
      "supportNote": "Chot.Don is one online store. Order and support requests are handled directly by our team.",
      ...
      "answers": [
        ...
        "How do I contact Chot.Don support?"
      ]
    },
    "faq": {
      "title": "Frequently Asked Questions",
      "desc": "Answers for common Chot.Don workflows: account, profile, cart, checkout, orders, payments, vouchers, shipping, returns, and support.",
      "search": "Search questions...",
      "empty": "No matching questions found.",
      "contactTitle": "Need a specific answer?",
      "contactDesc": "Send your order number, contact details, and screenshots so Chot.Don can check the issue directly.",
      "contactCta": "Contact Support",
      "topics": [
        {
          ...
          "faqs": [
            ...
            {
              "q": "How can I keep my Chot.Don account safe?",
        ...
        },
        {
          ...
          "faqs": [
            ...
            },
            {
              ...
              "a": "Keep your phone reachable. If delivery fails or the carrier cannot contact you, send your order number to support so Chot.Don can check the next step."
            }
          ]
        },
        {
    ...
    "shipping": {
      "title": "Shipping Information",
      "desc": "Delivery coverage, fees, tracking, failed delivery, and package issue guidance for Chot.Don orders.",
        ...
        },
        {
          ...
          "faqs": [
            ...
            },
            {
              ...
              "a": "Processing starts after the order is placed and required payment checks are complete. Chot.Don prepares the items before handing them to delivery."
            }
          ]
        },
        {
  ...
  "Privacy": {
    ...
    "description": "This policy explains how Chot.Don collects, uses, stores, and protects customer information when you use our online store.",
    ...
    "sections": [
      {
        ...
        "title": "1. Overview",
        "paragraphs": [
          "1.1. Chot.Don operates an online store where customers can browse products, create accounts, save addresses, place orders, manage carts, receive notifications, and contact support.",
          "1.2. This Privacy Policy explains what information we collect, why we collect it, how we use it, and the choices you have when using Chot.Don.",
          "1.3. By using Chot.Don, creating an account, placing an order, or contacting support, you acknowledge that your information will be handled as described in this policy.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "2.4. Payment information: payment method, payment status, transaction reference, refund status, and limited payment metadata. Full card, bank, or wallet credentials may be processed by payment providers and are not intended to be stored by Chot.Don.",
      ...
      },
      {
        ...
        "paragraphs": [
          "5.1. Chot.Don may use cookies, local storage, and similar technologies to keep you signed in, remember preferences, store cart or theme settings, improve navigation, and measure usage.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "6.5. If Chot.Don is involved in a business transfer, merger, financing, reorganization, or sale of assets, customer information may be transferred as part of that transaction subject to appropriate safeguards."
        ]
      },
      {
        "id": "security",
      ...
      },
      {
        ...
        "paragraphs": [
          "10.1. Chot.Don and its service providers may process or store information in countries where our infrastructure, support, or technology partners operate.",
      ...
      },
      {
        ...
        "title": "11. Contact Us",
        "paragraphs": [
          "11.1. If you have questions about this Privacy Policy or want to exercise a privacy request, contact Chot.Don support through the help or contact page.",
  ...
  "ProductsPage": {
    ...
    "filterDrawerDescription": "Refine products by category, price, and rating.",
    "search": "Search",
  ...
  "Terms": {
    ...
    "description": "These terms explain how customers use Chot.Don to browse products, place orders, manage accounts, and buy directly from our online store.",
    "toc": "Table of Contents",
    "sections": [
      {
        "id": "overview",
        "title": "1. Overview",
        "paragraphs": [
          "1.1. Chot.Don provides an online store where customers can discover products sold by Chot.Don, manage shopping carts, place orders, receive order updates, save favorite items, and use account features related to shopping activity.",
          "1.2. By accessing Chot.Don, creating an account, or placing an order, you agree to follow these Terms of Service and any policies referenced from the checkout, account, shipping, return, or privacy pages.",
          ...
          "1.4. Chot.Don may update these terms when platform features, legal requirements, or operating policies change. Continued use of the platform after an update means you accept the revised terms."
        ]
      },
      {
        "id": "accounts",
        ...
        "paragraphs": [
          ...
          "2.3. Chot.Don may request additional profile information before allowing checkout or other account actions when that information is required for delivery, fraud prevention, support, or legal compliance.",
          "2.4. Chot.Don may limit, suspend, or close an account that appears to be used for fraud, abuse, unauthorized access, payment misuse, repeated policy violations, or activity that disrupts the platform."
        ]
      },
      {
        "id": "products",
        ...
        "paragraphs": [
          "3.1. Chot.Don aims to show product names, descriptions, images, categories, brand information, prices, discounts, stock status, ratings, and related product details as clearly as possible.",
          ...
          "3.4. If a product is listed with an obvious error, unavailable inventory, incorrect price, or unsupported shipping condition, Chot.Don may cancel or adjust the affected order and notify you through the available contact channels."
        ]
      },
      {
        "id": "orders",
        ...
        "paragraphs": [
          ...
          "4.3. Chot.Don may reject, cancel, or hold an order when payment cannot be verified, delivery information is incomplete, inventory is unavailable, fraud is suspected, or the order violates store policies.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "5.3. Chot.Don may refuse or reverse promotional benefits that are applied because of technical errors, suspicious activity, duplicated use, resale behavior, or violation of promotion rules.",
      ...
      },
      {
        ...
        "paragraphs": [
          "7.1. Cancellation, return, exchange, and refund eligibility depends on product type, order status, Chot.Don's return policy, payment method, and applicable consumer protection requirements.",
          ...
          "7.4. Chot.Don may reject return or refund requests involving abuse, altered products, missing items, false claims, late submissions, or conditions outside the stated return policy."
        ]
      },
      {
        "id": "user-conduct",
        ...
        "paragraphs": [
          "8.1. You agree not to misuse Chot.Don, interfere with platform operations, access systems without authorization, scrape protected data, submit fraudulent orders, abuse vouchers, manipulate reviews, or impersonate another person.",
          ...
          "8.3. Chot.Don may moderate, remove, limit, or report content or activity that violates these terms, harms users, creates security risk, or conflicts with applicable law."
        ]
      },
      {
        "id": "privacy",
        ...
        "paragraphs": [
          "9.1. Chot.Don collects and uses account, order, browsing, device, notification, and support information as described in the Privacy Policy.",
      ...
      },
      {
        ...
        "paragraphs": [
          "10.1. Chot.Don works to keep the platform reliable, but access may be interrupted by maintenance, network issues, third-party service failures, security events, or changes to platform features.",
          "10.2. To the extent permitted by law, Chot.Don is not responsible for indirect, incidental, punitive, or consequential losses arising from use of the platform, delayed delivery, unavailable products, third-party services, or user misuse.",
      ...
      },
      {
        ...
        "title": "11. Support",
        "paragraphs": [
          "11.1. If you have questions about these terms, an order, a payment, a return, your account, or a platform issue, contact Chot.Don support through the help or contact page.",
